...
print('Site with the largest successful launches is VAFB SLC-4E')
print('Site with the highest launch success rate is CCAFS SLC-40')
print('Payload Range(s) with the highest launch success rate is the payload mass from 0-4k kg')
print('Payload Range(s) with the lowest launch success rate is the payload mass from 6k-7k kg')
print('The F9 Booster version that has the highest launch success rate is B4')
